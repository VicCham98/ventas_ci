...
class Categorias extends CI_Controller {
    ...
    public function store(){
        ...
        //$this->form_validation->set_rules(nombre del campo, alias,regla de vvalidacion)
        ...
        if ($this->form_validation->run()) {
            ...
            if ($this->Categorias_model->save($data)) {
                ...
                $this->session->set_flashdata("error","No se pudo guardar la informació");
    ...
    public function update(){
        ...
        if ($this->form_validation->run()) {
            ...
            if ($this->Categorias_model->update($idCategoria, $data)) {
                ...
                $this->session->set_flashdata("error","No se pudo actualizar la informació");
